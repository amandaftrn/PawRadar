...
class _CareChecklistScreenState extends State<CareChecklistScreen> {
  ...
  void initState() {
    ...
    _tasks.addAll([
      CareTask(
        title: 'Jalan Pagi',
        description: 'Ajak Max jalan pagi selama 30 menit',
        dueDate: DateTime(now.year, now.month, now.day, 8, 0),
        petName: 'Max',
      ),
      CareTask(
        title: 'Jalan Sore',
        description: 'Ajak Max jalan sore selama 20 menit',
        dueDate: DateTime(now.year, now.month, now.day, 18, 0),
        petName: 'Max',
      ),
      CareTask(
        title: 'Sarapan',
        description: '1 cup makanan kering',
      ...
      CareTask(
        title: 'Makan Malam',
        description: '1 cup makanan kering + sumplemen',
        dueDate: DateTime(now.year, now.month, now.day, 19, 0),
        petName: 'Max',
      ),
      CareTask(
        title: 'Obat',
        description: '1 tablet setelah sarapan',
      ...
      CareTask(
        title: 'Sisir',
        description: 'Sisir bulu Bella selama 10 menit',
      ...
      CareTask(
        title: 'Sarapan',
        description: '1/2 cup makanan basah',
        dueDate: DateTime(now.year, now.month, now.day, 7, 0),
        petName: 'Bella',
        isCompleted: true,
      ),
